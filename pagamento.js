async function gerarPagamentoPIX(valor, nome, email) {
  try {
    ...
    document.getElementById("pixChave").innerHTML = `
      <h3 style="margin:10px 0;color:#fff;">Valor: R$ ${valor.toFixed(2)}</h3>
      <img src="data:image/png;base64,${data.qr_code_base64}" alt="QR PIX" style="width:200px;margin:10px;border-radius:8px;">
